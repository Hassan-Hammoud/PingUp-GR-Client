        ...
        <div className='bg-white rounded-lg shadow p-6'>
          ...
          >
            ...
            <div className=''>
              ...
              <textarea
                rows={3}
                className='resize-none w-full p-3 border border-gray-200 rounded-lg'
            ...
            <div className='flex justify-end space-x-3 pt-6'>
              <button
                ...
                className='px-4 py-4 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'
              >
                Cancel
              </button>
              <button
